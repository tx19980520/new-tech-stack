...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Woman c = new Woman();
    Man d = new Man();
    a.Print(); // normal override see right type
    b.Print(); // normal override see right type
    c.Print(); // normal function call see right type
    d.Print(); // normal function call see right type
    Main m = new Main();
